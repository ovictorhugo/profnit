import { X, User, Buildings, Quotes, Book, Books, ChartBar, ArrowDown, CaretDown, ArrowUDownLeft, PuzzlePiece, MapPin, LinkSimple, IdentificationBadge, SquaresFour, Rows, Calendar, CalendarBlank, CaretCircleRight, CaretCircleLeft, MagnifyingGlass, File, Stamp, Student, GraduationCap, Code, StripeLogo, Files } from "phosphor-react";
      ...
      <div className="w-full  justify-center flex pb-20" >
        <div className="bg-white rounded-md p-12 w-full h-full">
          ...
          <div className="w-full flex justify-center ">
            <div className="bg-cover bg-center bg-no-repeat h-24 w-24 bg-white rounded-md mb-3 border-4 border-white top-[-75px] relative " style={{ backgroundImage: `url(http://servicosweb.cnpq.br/wspessoa/servletrecuperafoto?tipo=1&id=${props.lattes_10_id}) ` }}></div>
          </div>
            ...
            <div className="flex w-full gap-6 h-full flex-col-reverse lg:flex-row">
              <div className="flex-1 h-full ">
                ...
                <Tabs>
                  ...
                  <TabPanel>
                    {valoresSelecionadosPopUp == '' || botaoAreasClicado || botaoPesquisadoresClicado ? (
                    ...
                    {botaoAreasClicado || botaoPesquisadoresClicado || (valoresSelecionadosPopUp == "" && valorDigitadoPesquisaDireta == "") ? (
                      ...
                      <div className="flex justify-between pb-8 w-full items-center">
