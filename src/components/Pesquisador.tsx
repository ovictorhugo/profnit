      ...
      <div onClick={handleOpenPopUp} id="id_perfil" className={`cursor-pointer group bg-white  border-gray-300 border-[1px]  items-center p-2 rounded-lg hover:shadow-md transition w-full   ${isOn && valoresSelecionadosExport != '' ? "flex items-center justify-between" : "flex flex-col"}`}>
        ...
        <div className={`flex ${isOn && valoresSelecionadosExport != '' ? "" : "flex-col"}`}>
          <div className={`flex items-center ${isOn && valoresSelecionadosExport != '' ? "" : "flex-col  "}`}>
            ...
            <div className={`whitespace-nowrap  bg-cover bg-center bg-no-repeat h-20 w-20 bg-white rounded-md border-4 border-white  relative ${isOn && valoresSelecionadosExport != '' ? "" : "top-[-40px]  mb-3"}`} style={{ backgroundImage: `url(http://servicosweb.cnpq.br/wspessoa/servletrecuperafoto?tipo=1&id=${props.lattes_10_id}) ` }}>
        ...
        <div key={props.id} className={"elementPesquisador flex justify-center transition-all fixed top-0 right-0 pb-24 w-full h-screen bg-[#000] z-[99999] bg-opacity-75 pt-20 overflow-y-auto overflow-x-hidden "}>
          ...
          <div className=" pt-20 flex flex-col fixed items-center h-screen right-0 top-0 w-32 z-[9999999]">
            ...
            <div className="mb-6 flex flex-col justify-center items-center">
              <div onClick={handleClosePopUp} className="mb-2 h-12 w-12 rounded-md bg-white items-center justify-center flex hover:bg-gray-100 cursor-pointer transition-all">
            ...
            <div className="mb-6 flex flex-col justify-center items-center">
              <div onClick={handleDownloadJson} className="mb-2 h-12 w-12 rounded-md bg-white items-center justify-center flex hover:bg-gray-100 cursor-pointer transition-all">
            ...
            <div className="mb-6 flex flex-col justify-center items-center">
              <Link to={linkTo} target="_blank" className="mb-2 h-12 w-12 rounded-md bg-blue-400 items-center justify-center flex hover:bg-blue-500 cursor-pointer transition-all">
                <ArrowSquareOut size={16} className="text-white" />
              </Link>
